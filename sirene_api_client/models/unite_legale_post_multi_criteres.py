...
T = TypeVar("T", bound="UniteLegalePostMultiCriteres")
...
class UniteLegalePostMultiCriteres:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unite_legale_post_multi_criteres = cls(
            q=q,
            date=date,
            champs=champs,
            nombre=nombre,
        ...
        unite_legale_post_multi_criteres.additional_properties = d
        return unite_legale_post_multi_criteres
