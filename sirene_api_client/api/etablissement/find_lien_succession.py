...
def _get_kwargs(
    *,
    q: Unset | str = UNSET,
    tri: Unset | FindLienSuccessionTri = UNSET,
    ...
    json_tri: Unset | str = UNSET
    if not isinstance(tri, Unset):
        json_tri = tri.value
...
) -> Any | ReponseErreur | ReponseLienSuccession | None:
    if response.status_code == 200:
        response_200 = ReponseLienSuccession.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient, response: httpx.Response
) -> Response[Any | ReponseErreur | ReponseLienSuccession]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        q (Union[Unset, str]):
        tri (Union[Unset, FindLienSuccessionTri]):
    ...
    Returns:
        Response[Union[Any, ReponseErreur, ReponseLienSuccession]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ReponseErreur, ReponseLienSuccession]
    """
