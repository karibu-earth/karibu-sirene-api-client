"""Tests for etablissement find_by_post_etablissement module."""
...
@pytest.mark.requirement("REQ-API-009")
...
@pytest.mark.requirement("REQ-API-010")
class TestBuildResponse:
    ...
    def test_build_response_success(self):
        ...
        with patch(
            "sirene_api_client.api.etablissement.find_by_post_etablissement._parse_response"
        ) as mock_parse:
...
@pytest.mark.requirement("REQ-API-011")
...
@pytest.mark.requirement("REQ-API-012")
class TestSync:
    """Test sync function."""
    ...
    def test_sync_success(self):
        ...
        with patch(
            "sirene_api_client.api.etablissement.find_by_post_etablissement.sync_detailed"
...
@pytest.mark.requirement("REQ-API-013")
...
@pytest.mark.requirement("REQ-API-014")
class TestAsyncio:
    ...
    async def test_asyncio_success(self):
        ...
        with patch(
            "sirene_api_client.api.etablissement.find_by_post_etablissement.asyncio_detailed"
